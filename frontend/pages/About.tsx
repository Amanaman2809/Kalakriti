      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-32 h-32 opacity-10 animate-spin-slow">
          <svg viewBox="0 0 100 100" className="w-full h-full">
            ...
            />
            <path
              d="M50,10 L55,25 L70,20 L60,35 L75,45 L60,50 L75,55 L60,65 L70,80 L55,75 L50,90 L45,75 L30,80 L40,65 L25,55 L40,50 L25,45 L40,35 L30,20 L45,25 Z"
              fill="currentColor"
      ...
      <div className="relative z-10 px-6 py-10 max-w-6xl mx-auto text-gray-800">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mb-6">
            ...
            <p className="text-lg italic text-gray-600 font-medium">
              जहाँ कला सिर्फ काम नहीं, एक विरासत है।
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-orange-100 p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="leading-relaxed text-gray-700">
                What started as a family-led tradition of handcrafting and
                showcasing local art has now evolved into a platform that aims
                to bring that same emotion, detail, and heritage to a global
                audience.
              </p>
            </div>
          </div>
        ...
        <div className="mb-16 text-center bg-white/80 backdrop-blur-sm rounded-2xl border border-orange-100 p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-3xl font-bold text-primary mb-6 tracking-wide">
              Our Mission
            </h3>
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <p className="text-xl text-primary/95 leading-relaxed font-light">
                <span className="font-semibold text-primary">
                  At Chalava, we want our audience to see not just the final
                  creation, but the soul within it.
                </span>
                <br />
                We believe every brushstroke has a backstory, every creation is
                rooted in emotion, and every artist has a journey worth sharing.
              </p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-10 animate-fadeIn my-10">
          ...
          <article className="relative bg-white bg-opacity-95 backdrop-blur-md rounded-3xl border-1 border-orange-100 transition-shadow duration-300 overflow-hidden cursor-pointer group">
            ...
            <div className="relative z-10 p-10 flex flex-col items-center text-center">
              ...
              <p className="mt-4 max-w-xs text-gray-700 leading-relaxed tracking-wide font-light">
                In today&apos;s digital age, Chalava is a vibrant canvas of
                stories — showcasing artisans’ passion and tradition woven into
                every masterpiece.
              </p>
            </div>
          ...
          <article className="relative bg-white bg-opacity-95 backdrop-blur-md rounded-3xl border-1 border-orange-100 transition-shadow duration-300 overflow-hidden cursor-pointer group">
            ...
            <div className="relative z-10 p-10 flex flex-col items-center text-center">
              ...
              <p className="mt-4 max-w-xs text-gray-700 leading-relaxed tracking-wide font-light">
                Empowering emerging artisans by providing a platform for their
                craft to reach the global audience.
              </p>
            </div>
          ...
          <article className="relative bg-white bg-opacity-95 backdrop-blur-md rounded-3xl border-1 border-orange-100 transition-shadow duration-300 overflow-hidden cursor-pointer group">
            ...
            <div className="relative z-10 p-10 flex flex-col items-center text-center">
              ...
              <p className="mt-4 max-w-xs text-gray-700 leading-relaxed tracking-wide font-light">
                Timeless handcrafted art conveying the rich cultural heritage
                and vibrant emotions of India.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                Based in the culturally rich city of Jaipur, Rajasthan, our
                roots are deeply tied to tradition, yet our eyes are set on the
                future. We operate with a small but passionate team committed to
                building a bridge between art and audience, emotion and
                expression, creator and collector.
              </p>
              ...
              <div className="bg-white/80 rounded-xl p-6 shadow-lg border border-orange-200">
                ...
                <p className="text-gray-800 font-medium">
                  P. NO. 5-A, Laxmi Vihar, Vaishali Marg, Meenawala,
                  <br />
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-primary/20 to-secondary/20 rounded-2xl p-8 text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Where tradition meets technology and creativity finds its
                  canvas
                </p>
              </div>
            </div>
